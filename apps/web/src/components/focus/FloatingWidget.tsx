...
export function FloatingWidget() {
  ...
  const btnCls =
    "w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 transition-colors flex items-center justify-center text-white";
  ...
  return (
    ...
    >
      <div className="bg-linear-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl border border-gray-700 overflow-hidden backdrop-blur-lg w-95">
              ...
              {isConnected && otherUsers.length > 0 && (
                <div className="px-4 pb-3 flex -space-x-2">
                  {otherUsers.slice(0, 6).map((user) => (
                    <div
                      key={user.userId}
                      className={`w-8 h-8 rounded-full border-2 border-gray-800 bg-gray-700 overflow-hidden relative ${
                  ...
                  {otherUsers.length > 6 && (
                    <div className="w-8 h-8 rounded-full border-2 border-gray-800 bg-gray-700 flex items-center justify-center text-xs font-medium text-white">
                      +{otherUsers.length - 6}
                    </div>
                  )}
                </div>
