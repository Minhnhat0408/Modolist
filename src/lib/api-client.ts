/**
 * API Helper to call Next.js API routes with Supabase session authentication.
 * Uses Supabase access_token as Bearer token.
 */
...
/** Returns the cached token synchronously (null if not yet fetched). */
